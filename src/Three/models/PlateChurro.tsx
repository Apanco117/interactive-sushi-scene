...
//. Types 
import type { GLTFResultPlateChurro } from '@/types/threetypes';
import { useMemo, useRef } from 'react';
import type { ThreeEvent } from '@react-three/fiber';

export function PlateChurros(props : RigidBodyProps ) {
    const filePath = `${ getPath() }/PlateChurro.glb`;
    const { nodes, materials } = useGLTFWithKTX2(filePath) as unknown as GLTFResultPlateChurro;
    ...
    const mergedVertices = useMemo(() => {
        ...
        const geometries = [
            nodes.Plate2.geometry.attributes.position.array,
        ];
    ...
    return (
        ...
        >
            <group onClick={handleClick} dispose={null}>
                <mesh castShadow receiveShadow geometry={nodes.Plate2.geometry} material={materials.Plate2Material}/>
            </group>
